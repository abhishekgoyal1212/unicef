...
use App\Http\Controllers\admin\ForgorPasswordController;
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
...
Route::controller(ForgorPasswordController::class)->group(function(){
	Route::view('forgot-password','admin/login/forgot_password')->name('forgot-password');
	Route::post('forgot-password-save','forgot_password_save')->name('admin.forgot_password_save');
	Route::get('update-password/{token}', 'get_password')->name('update-password');
	Route::post('update-password_save', 'update_password')->name('update-password');
});
Route::prefix('admin')->group(function(){
