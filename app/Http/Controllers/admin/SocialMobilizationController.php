...
class SocialMobilizationController extends Controller
{
    ...
    $user = SmMeetingInstitutionsReligious::where('user_id', '=', $user_id)->WhereDate('created_at', $today_date)->count();
    if($user == 0){
...
public function insert_sm_meeting_influencers(Request $request){
    $user_id = Auth::id();
    $today_date = date('Y-m-d');
    $user = SmMeetingInfluencer::where('user_id', '=', $user_id)->WhereDate('created_at', $today_date)->count();
    if($user == 0){
           $validator = Validator::make($request->all(), [
             'number_meetings' => 'required|numeric',
             'number_participants_male' => 'required|numeric',
           ...
           if($result){
                ...
                return redirect()->back()->with('flash-error', 'Today Details Already Submitted')->with('meeting-influencers', 'meeting-influencer');
        }
}
...
public function insert_sm_meeting_numbers(Request $request){
    $user_id = Auth::id();
    $today_date = date('Y-m-d');
    $user = SmMeetingNumbers::where('user_id', '=', $user_id)->WhereDate('created_at', $today_date)->count();
    if($user == 0){
            $validator = Validator::make($request->all(), [
                'lions_club' => 'required',
                'rotary' => 'required',
           ...
           if($result){
            ...
            return redirect()->back()->with('flash-error', 'Today Details Already Submitted')->with('number-meeting', 'number-meeting');
    }
}
    ...
    if($user == 0){
        ...
        if($result){
            ...
            return redirect()->back()->with('flash-error', 'Today Details Already Submitted')->with('meeting-ipc', 'meeting-ipc');
    }
...
public function insert_sm_mother_meeting(Request $request){
    $user_id = Auth::id();
    $today_date = date('Y-m-d');
    $user = SmMeetingMother::where('user_id', '=', $user_id)->WhereDate('created_at', $today_date)->count();
    if($user == 0){
        $validator = Validator::make($request->all(), [
            'number_meetings' => 'required|numeric',
            'number_participants_male' => 'required|numeric',
        ...
        if($result){
            ...
            return redirect()->back()->with('flash-error', 'Error occured in adding data');
             ...
             return redirect()->back()->with('flash-error', 'Today Details Already Submitted')->with('mother-meeting', 'mother-meeting');
    }
...
public function sm_community(Request $request){
    $user_id = Auth::id();
    $today_date = date('Y-m-d');
    $user = SmMeetingCommunity::where('user_id', '=', $user_id)->WhereDate('created_at', $today_date)->count();
    if($user == 0){
            $validator = Validator::make($request->all(), [
                'number_meetings' => 'required|numeric',
                'number_participants_male' => 'required|numeric',
           ...
           if($result){
            ...
            return redirect()->back()->with('flash-error', 'Error occured in adding data');
             ...
             return redirect()->back()->with('flash-error', 'Today Details Already Submitted')->with('community-meeting', 'community-meeting');
    }
}
